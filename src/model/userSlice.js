...
export const verifyUser = createAsyncThunk(
  ...
  async ({ email, verificationCode }, thunkAPI) => {
    try {
      const response = await axios.post(`${URL}/api/users/verify`, { email, verificationCode });
...
export const resendVerificationCode = createAsyncThunk(
  ...
  async (email, thunkAPI) => {
    try {
      const response = await axios.post(`${URL}/api/users/resend-code`, { email });
...
export const resetPassword = createAsyncThunk(
  ...
  async ({ email, resetCode, newPassword }, thunkAPI) => {
    try {
      const response = await axios.post(`${URL}/api/users/reset-password`, { email, resetCode, newPassword });
...
export const addStaff = createAsyncThunk(
  ...
  async (staffData, thunkAPI) => {
    try {
      ...
      const response = await axios.post(`${URL}/api/users/addStaff`, staffData, {
        headers: {
          Authorization: `Bearer ${token}`, // Thêm token vào header
        },
      });
