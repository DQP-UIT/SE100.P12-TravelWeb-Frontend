...
const generateRoomData = (month) => {
    const services = ['Khách Sạn Vũ Với', 'Khách sạn Hà My ', 'Winston Hotel Riverside Thu Duc'];
    const rooms = ['Phòng Delux', 'Suite', 'Family Suite', 'Phòng Tiêu chuẩn giường King','Deluxe giường đôi'];
